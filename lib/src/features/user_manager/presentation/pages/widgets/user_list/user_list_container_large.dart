...
class UserListContainerLarge extends StatelessWidget {
  const UserListContainerLarge({super.key, required this.firstName, required this.lastName, required this.userName, required this.email, required this.gender, required this.enrolled, required this.index, required this.phoneNumber, required this.birthday, required this.job});
  final int index;
